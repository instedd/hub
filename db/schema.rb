...
ActiveRecord::Schema.define(version: 20141121140050) do
  ...
  add_index "event_handlers", ["target_connector_id"], name: "index_event_handlers_on_target_connector_id", using: :btree
